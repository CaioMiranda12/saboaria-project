    ...
    <div className="bg-[#f7f3ec] text-[#1a2e1f]">
      ...
      <section className="min-h-screen grid grid-cols-2 pt-20">
        <div className="flex flex-col justify-center px-20 py-20">
          ...
          <h1 className="font-serif text-6xl leading-tight text-[#2d4f38] mb-6">
            Limpeza que<br />
            <em className="text-[#4a7c59]">cuida do planeta</em>
          </h1>
          <p className="text-[#5a6b5e] text-lg leading-relaxed font-light max-w-md mb-10">
          ...
          <div className="flex gap-4 items-center">
            <Link to="/produtos" className="bg-[#4a7c59] text-white px-8 py-3.5 rounded-full text-sm font-medium hover:bg-[#2d4f38] transition-all hover:-translate-y-0.5">
              Ver produtos
            </Link>
        ...
        <div className="relative bg-[#4a7c59] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 opacity-5 bg-[repeating-linear-gradient(45deg,#fff,#fff_1px,transparent_1px,transparent_30px)]" />
          <div className="relative z-10 w-80 h-96 bg-white/10 rounded-3xl border border-white/20 flex items-center justify-center flex-col gap-4">
      ...
      <div className="grid grid-cols-3 border-y border-[#4a7c59]/15">
        {[
          ...
          <div key={i} className={`py-10 text-center ${i < 2 ? 'border-r border-[#4a7c59]/15' : ''}`}>
            <p className="font-serif text-4xl font-bold text-[#4a7c59] mb-1">{stat.num}</p>
            <p className="text-xs text-[#5a6b5e] font-light">{stat.label}</p>
          </div>
        ))}
      </div>

      {/* Sobre */}
      <section className="grid grid-cols-2 gap-24 px-20 py-24 bg-white border-t border-[#4a7c59]/10">
        <div>
          <p className="text-xs font-medium tracking-widest uppercase text-[#4a7c59] mb-3">Quem somos</p>
          <h2 className="font-serif text-4xl text-[#2d4f38] leading-tight mb-5">
        ...
        <div className="bg-[#4a7c59] rounded-3xl flex items-center justify-center p-12 min-h-96">
          <div className="text-center text-white">
            <h3 className="font-serif text-3xl font-bold mb-3">Economia Circular</h3>
      ...
      {/* Produtos */}
      <section className="px-20 py-24 bg-[#f7f3ec]">
        <div className="flex justify-between items-end mb-12">
          <div>
            <p className="text-xs font-medium tracking-widest uppercase text-[#4a7c59] mb-3">Nossos produtos</p>
            <h2 className="font-serif text-4xl text-[#2d4f38]">
              Limpeza <em className="text-[#4a7c59]">natural</em> para cada necessidade
            </h2>
          </div>
          <Link to="/produtos" className="text-[#4a7c59] text-sm font-medium hover:gap-2 flex items-center gap-1 transition-all">
            Ver todos →
          </Link>
        </div>
      ...
      {/* Processo */}
      <section className="px-20 py-24 bg-white border-t border-[#4a7c59]/10">
        <p className="text-xs font-medium tracking-widest uppercase text-[#4a7c59] mb-3">Como fazemos</p>
        <h2 className="font-serif text-4xl text-[#2d4f38] mb-12">
      ...
      {/* CTA */}
      <section className="px-20 py-24 bg-[#2d4f38] text-center flex flex-col items-center">
        ...
        <div className="flex gap-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-white text-[#2d4f38] px-8 py-3.5 rounded-full text-sm font-medium hover:opacity-90 transition-opacity"
          >
            Pedir pelo WhatsApp
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="border border-white/30 text-white px-8 py-3.5 rounded-full text-sm font-light hover:border-white transition-colors"
          >
            @saboariaecologica
          </a>
        </div>
      ...
      {/* Footer */}
      <footer className="px-20 py-6 flex justify-between items-center border-t border-[#4a7c59]/15 bg-[#f7f3ec]">
